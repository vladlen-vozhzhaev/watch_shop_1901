                        ...
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" method="POST" action="{{ route('login') }}" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <input autofocus required type="email" class="form-control" id="name" name="email" placeholder="Адрес электронной почты">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <input required type="password" class="form-control" id="password" name="password" placeholder="Пароль">
                                </div>
                                <div class="col-md-12 form-group">
                                    <input type="submit" class="btn_3" value="Войти">
